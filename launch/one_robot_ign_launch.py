import os, xacro # pyright: ignore[reportMissingImports]
from pathlib import Path
from ament_index_python.packages import get_package_share_directory # pyright: ignore[reportMissingImports]
from launch import LaunchDescription
from launch.actions import DeclareLaunchArgument, IncludeLaunchDescription, SetEnvironmentVariable # pyright: ignore[reportMissingImports]
...
robot_model = 'caster_diffbot' #caster_diffbot, sensors_diffbot, ugv_4wheels, omnibot
...
world_file = 'empty.sdf' # empty, warehouse

def generate_launch_description():

    this_pkg_path = os.path.join(get_package_share_directory('ign_robots_examples'))
